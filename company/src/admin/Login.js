        ...
        return (
            <div className='container'>
                ...
                <div className='form-group'>
                    ...
                    {this.state.erro && <small id='emailHelp' className='form-text text-muted'>Email ou senha inválidos.</small>}
                </div>

                <button type='button' disabled={this.state.estaLogando} onClick={this.autenticaUsuario} className='btn btn-primary'>Submit</button>
